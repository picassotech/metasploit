...
echo "Creating database wait"

cd $msfpath/metasploit-framework/config

curl -LO https://raw.githubusercontent.com/picassotech/metasploit/master/database.yml
...
echo "you can directly use msfvenom or msfconsole rather than ./msfvenom or ./msfconsole. also don't forget to Subscribe armour technology on YouTube"